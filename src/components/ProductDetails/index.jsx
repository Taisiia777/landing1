  ...
  return (
    <div {...props} className={`${props.className} flex flex-col w-full gap-6 py-6 sm:py-5 bg-white-a700 shadow-xs rounded-[10px]`}>
      ...
      <div className="mx-6 flex flex-col gap-2 self-stretch">
        <Button className="flex h-[48px] flex-row items-center justify-center self-stretch rounded-[10px] bg-red-900 px-[34px] text-center text-[16px] text-white-a700 sm:px-5">
          {addToCartButton}
        </Button>
        <Button className="flex h-[48px] flex-row items-center justify-center self-stretch rounded-[10px] border border-solid border-red-900 px-[33px] text-center text-[16px] text-red-900 sm:px-5">
          {viewDetailsButton}
        </Button>
      </div>
    </div>
